<ul class="sidebar navbar-nav">
    ...
    <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href="#"> <i class="fa fa-fw fa-bar-chart"></i> Sales Reports</a>
        <a class="dropdown-item" href=""> <i class="fa fa-fw fa-tags"></i> Inventory Reports</a>
        <a class="dropdown-item" href="#"> <i class="fa fa-fw fa-money"></i> Payment Reports</a>
        </div>
    </li>
    <li class="nav-item dropdown">
        <a class="nav-link" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
        <a class="dropdown-item" href="#"> <i class="fa fa-fw fa-table"></i> Check Sales</a>
    ...
    <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href=""> <i class="fa fa-tags"></i> All Products</a>
        </div>
    </li>
    <li class="nav-item dropdown">
        <a class="nav-link" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <a class="dropdown-item" href=""> <i class="fa fa-tags"></i> All Product Types</a>
        </div>
    </li>
    <li class="nav-item dropdown">
        <a class="nav-link" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <a class="dropdown-item" href=""> <i class="fa fa-fw fa-users"></i> All Vendors</a>
        </div>
    </li>
    <li class="nav-item dropdown">
        <a class="nav-link" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <a class="dropdown-item" href=""> <i class="fa fa-fw fa-industry"></i> All Brands</a>
        </div>
    </li>
    <li class="nav-item">
